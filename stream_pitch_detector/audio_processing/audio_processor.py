...
class AudioProcessor:
    ...
    def __init__(self, buffer_size: int = 512, hop_size: int = 512, sample_rate: int = 44100, unit: str = "Hz", tolerance: float = 0.8):
        ...
        self.pitch_detector = aubio.pitch("default", self.buffer_size, self.hop_size, self.sample_rate)
